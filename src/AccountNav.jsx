...
export default function AccountNav(){
    ...
    function linkClasses(type=null){ //'type' is a name I chose for the parameter, 'null' is the default value when no para is provided 
        
        // console.log('inside linkClass '+ type);
        const {pathname} = useLocation();

        let subpage = pathname.split('/')?.[2];//But pathname is always gonna be '/account/...' ?, then why check if pathname is 'null' or 'undefined'
